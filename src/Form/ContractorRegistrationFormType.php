...
class ContractorRegistrationFormType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
            ...
            ->add('ContractorType', ChoiceType::class, [
                'label' => 'Contractor Type:',
                'choices' => [
                    'Earth Movers' => 'Earth Movers',
                    'Road Work Contractor' => 'Road Work Contractor',
                    'Building Construction Contractor' => 'Building Construction Contractor',
                    'General Contractor' => 'General Contractor',
                    'Electrical Contractor' => 'Electrical Contractor',
                    'Plumbing Contractor' => 'Plumbing Contractor',
                    'Carpentry Contractor' => 'Carpentry Contractor',
            ...
            ->add('Specialization', TextType::class, [
                ...
                'attr' => [
                    'maxlength' => 190,
                    'data-hint' => 'Example: Residential, Commercial, Electrical'
                ],
                'required' => true,
