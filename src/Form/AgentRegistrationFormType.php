...
class AgentRegistrationFormType extends AbstractType
{
    ...
    {
        $builder
            // Change ChoiceType to HiddenType
            ->add('customertype', HiddenType::class, [
                'data' => 'Agent', // Set the default value
                'mapped' => true,  // Ensures it is processed in the form submission
            ])
            ...
            ->add('phone', TextType::class, [
                ...
                'label' => 'Phone:',
                'attr' => [
                    'title' => 'Enter WhatsApp Enabled Phone Number',
                    'maxlength' => 190
                ],
                'required' => true
            ])
            ...
            ->add('AgentID', ChoiceType::class, [
                'label' => 'Channel Partner ID',
                'choices' => $options['channelPartners'], // Use the channel partners data passed from the controller
                'required' => true,
                'attr' => [
                    'class' => 'form-control'
                ]
            ...
            ->add('recaptchaToken', HiddenType::class, [
                'mapped' => false, // This field is not mapped to the Customer entity
            ]);
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'hidePassword' => false,
            'channelPartners' => [], // Default empty array for channel partners
        ]);
    }
}
